...
if __name__ == "__main__":
    ...
    # Uncomment the following configs to run for stories document
    chunk_size = app_config["notices_rag"]["chunk_size"]
    chunk_overlap = app_config["notices_rag"]["chunk_overlap"]
    embedding_model = app_config["notices_rag"]["embedding_model"]
    vectordb_dir = app_config["notices_rag"]["vectordb"]
    collection_name = app_config["notices_rag"]["collection_name"]
    doc_dir = app_config["notices_rag"]["unstructured_docs"]
